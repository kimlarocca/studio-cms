...
$date12 = date("Y-m-d");
$result12 = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND dateAdded > DATE_SUB(CURDATE(), INTERVAL 1 MONTH)");
$row12 = $result12->fetch_row();
$attendance12 = $row12[0];

$date12b = strtotime ( '-12 months' , strtotime ( $date12 ) ) ;
$date12b = date( 'Y-m-d', $date12b );
$result12b = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date12b."' AND dateAdded > DATE_SUB('".$date12b."', INTERVAL 1 MONTH))");
$row12b = $result12b->fetch_row();
$attendance12b = $row12b[0];

$date11 = strtotime ( '-1 months' , strtotime ( $date12 ) ) ;
$date11 = date( 'Y-m-d', $date11 );
$result11 = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date11."' AND dateAdded > DATE_SUB('".$date11."', INTERVAL 1 MONTH))");
$row11 = $result11->fetch_row();
$attendance11 = $row11[0];

$date11b = strtotime ( '-12 months' , strtotime ( $date11 ) ) ;
$date11b = date( 'Y-m-d', $date11b );
$result11b = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date11b."' AND dateAdded > DATE_SUB('".$date11b."', INTERVAL 1 MONTH))");
$row11b = $result11b->fetch_row();
$attendance11b = $row11b[0];

$date10 = strtotime ( '-1 months' , strtotime ( $date11 ) ) ;
$date10 = date( 'Y-m-d', $date10 );
$result10 = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date10."' AND dateAdded > DATE_SUB('".$date10."', INTERVAL 1 MONTH))");
$row10 = $result10->fetch_row();
$attendance10 = $row10[0];

$date10b = strtotime ( '-12 months' , strtotime ( $date10 ) ) ;
$date10b = date( 'Y-m-d', $date10b );
$result10b = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date10b."' AND dateAdded > DATE_SUB('".$date10b."', INTERVAL 1 MONTH))");
$row10b = $result10b->fetch_row();
$attendance10b = $row10b[0];

$date9 = strtotime ( '-1 months' , strtotime ( $date10 ) ) ;
$date9 = date( 'Y-m-d', $date9 );
$result9 = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date9."' AND dateAdded > DATE_SUB('".$date9."', INTERVAL 1 MONTH))");
$row9 = $result9->fetch_row();
$attendance9 = $row9[0];

$date9b = strtotime ( '-12 months' , strtotime ( $date9 ) ) ;
$date9b = date( 'Y-m-d', $date9b );
$result9b = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date9b."' AND dateAdded > DATE_SUB('".$date9b."', INTERVAL 1 MONTH))");
$row9b = $result9b->fetch_row();
$attendance9b = $row9b[0];

$date8 = strtotime ( '-1 months' , strtotime ( $date9 ) ) ;
$date8 = date( 'Y-m-d', $date8 );
$result8 = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date8."' AND dateAdded > DATE_SUB('".$date8."', INTERVAL 1 MONTH))");
$row8 = $result8->fetch_row();
$attendance8 = $row8[0];

$date8b = strtotime ( '-12 months' , strtotime ( $date8 ) ) ;
$date8b = date( 'Y-m-d', $date8b );
$result8b = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date8b."' AND dateAdded > DATE_SUB('".$date8b."', INTERVAL 1 MONTH))");
$row8b = $result8b->fetch_row();
$attendance8b = $row8b[0];

$date7 = strtotime ( '-1 months' , strtotime ( $date8 ) ) ;
$date7 = date( 'Y-m-d', $date7 );
$result7 = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date7."' AND dateAdded > DATE_SUB('".$date7."', INTERVAL 1 MONTH))");
$row7 = $result7->fetch_row();
$attendance7 = $row7[0];

$date7b = strtotime ( '-12 months' , strtotime ( $date7 ) ) ;
$date7b = date( 'Y-m-d', $date7b );
$result7b = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date7b."' AND dateAdded > DATE_SUB('".$date7b."', INTERVAL 1 MONTH))");
$row7b = $result7b->fetch_row();
$attendance7b = $row7b[0];

$date6 = strtotime ( '-1 months' , strtotime ( $date7 ) ) ;
$date6 = date( 'Y-m-d', $date6 );
$result6 = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date6."' AND dateAdded > DATE_SUB('".$date6."', INTERVAL 1 MONTH))");
$row6 = $result6->fetch_row();
$attendance6 = $row6[0];

$date6b = strtotime ( '-12 months' , strtotime ( $date6 ) ) ;
$date6b = date( 'Y-m-d', $date6b );
$result6b = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date6b."' AND dateAdded > DATE_SUB('".$date6b."', INTERVAL 1 MONTH))");
$row6b = $result6b->fetch_row();
$attendance6b = $row6b[0];

$date5 = strtotime ( '-1 months' , strtotime ( $date6 ) ) ;
$date5 = date( 'Y-m-d', $date5 );
$result5 = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date5."' AND dateAdded > DATE_SUB('".$date5."', INTERVAL 1 MONTH))");
$row5 = $result5->fetch_row();
$attendance5 = $row5[0];

$date5b = strtotime ( '-12 months' , strtotime ( $date5 ) ) ;
$date5b = date( 'Y-m-d', $date5b );
$result5b = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date5b."' AND dateAdded > DATE_SUB('".$date5b."', INTERVAL 1 MONTH))");
$row5b = $result5b->fetch_row();
$attendance5b = $row5b[0];

$date4 = strtotime ( '-1 months' , strtotime ( $date5 ) ) ;
$date4 = date( 'Y-m-d', $date4 );
$result4 = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date4."' AND dateAdded > DATE_SUB('".$date4."', INTERVAL 1 MONTH))");
$row4 = $result4->fetch_row();
$attendance4 = $row4[0];

$date4b = strtotime ( '-12 months' , strtotime ( $date4 ) ) ;
$date4b = date( 'Y-m-d', $date4b );
$result4b = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date4b."' AND dateAdded > DATE_SUB('".$date4b."', INTERVAL 1 MONTH))");
$row4b = $result4b->fetch_row();
$attendance4b = $row4b[0];

$date3 = strtotime ( '-1 months' , strtotime ( $date4 ) ) ;
$date3 = date( 'Y-m-d', $date3 );
$result3 = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date3."' AND dateAdded > DATE_SUB('".$date3."', INTERVAL 1 MONTH))");
$row3 = $result3->fetch_row();
$attendance3 = $row3[0];

$date3b = strtotime ( '-12 months' , strtotime ( $date3 ) ) ;
$date3b = date( 'Y-m-d', $date3b );
$result3b = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date3b."' AND dateAdded > DATE_SUB('".$date3b."', INTERVAL 1 MONTH))");
$row3b = $result3b->fetch_row();
$attendance3b = $row3b[0];

$date2 = strtotime ( '-1 months' , strtotime ( $date3 ) ) ;
$date2 = date( 'Y-m-d', $date2 );
$result2 = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date2."' AND dateAdded > DATE_SUB('".$date2."', INTERVAL 1 MONTH))");
$row2 = $result2->fetch_row();
$attendance2 = $row2[0];

$date2b = strtotime ( '-12 months' , strtotime ( $date2 ) ) ;
$date2b = date( 'Y-m-d', $date2b );
$result2b = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date2b."' AND dateAdded > DATE_SUB('".$date2b."', INTERVAL 1 MONTH))");
$row2b = $result2b->fetch_row();
$attendance2b = $row2b[0];

$date1 = strtotime ( '-1 months' , strtotime ( $date2 ) ) ;
$date1 = date( 'Y-m-d', $date1 );
$result1 = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date1."' AND dateAdded > DATE_SUB('".$date1."', INTERVAL 1 MONTH))");
$row1 = $result1->fetch_row();
$attendance1 = $row1[0];

$date1b = strtotime ( '-12 months' , strtotime ( $date1 ) ) ;
$date1b = date( 'Y-m-d', $date1b );
$result1b = $conn->query("SELECT count(*) FROM attendance WHERE studioID = '".$studioID."' AND (dateAdded <= '".$date1b."' AND dateAdded > DATE_SUB('".$date1b."', INTERVAL 1 MONTH))");
$row1b = $result1b->fetch_row();
$attendance1b = $row1b[0];

?>
  <h2 class="twd_centered">Attendance: Year Over Year Comparision</h2>
