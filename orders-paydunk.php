...
mysql_select_db($database_wotg, $wotg);
$query_orders = "SELECT * FROM orders WHERE (paymentType = 'Paydunk' AND orderStatus = 'complete' OR orderStatus = 'complete Paydunk') AND studioID = ".$row_currentUser['studioID']." ORDER BY orderID DESC";
...
<h1 class="twd_centered"><?php echo $row_currentUser['studioName']; ?> | Orders (<?php echo $totalRows_orders; ?>)</h1>
...
<div class="twd_container">
  <table border="0" align="center" cellpadding="3" cellspacing="0">
    <tr>
      ...
      <?php do { ?>
        <tr>
          <td><?php echo $row_orders['orderID']; ?></td>
          <td><?php 
