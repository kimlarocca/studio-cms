...
<h2 class="twd_centered">Manage Members <span class="twd_centered twd_margin20" style="padding:20px 0 0 0"><a id="addClass" href="javascript:void();" class="tooltip" title="add a new member"><img src="images/plus.png" width="22" height="22" /></a></span></h2>
  <?php
//delete record
if ($_GET['action'] == 'delete') {
...
<?php include("members-add-include.php"); ?>

</div>
  <p class="twd_centered twd_margin20">Click on any member's name to update or delete.</p>
