...
mysql_select_db($database_wotg, $wotg);
$query_instructors = "SELECT * FROM instructors WHERE securityLevel = 'Instructor' AND studioID = ".$row_currentUser['studioID']." AND active = 1 ORDER BY lastName ASC";
...
<div class="twd_container">
  <h2 style="padding-bottom:20px" class="twd_centered">Instructor Attendance Report</h2>
