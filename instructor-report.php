<?php
if ($_GET['instructorID']=='all') header("Location: instructor-report2.php?startDate=".$_GET['startDate']."&endDate=".$_GET['endDate']);
...
mysql_select_db($database_wotg, $wotg);
//$query_attendance = sprintf("SELECT * FROM attendance,classes WHERE attendance.instructorID = ".$_GET['instructorID']." AND attendance.classID = classes.classID AND DATE(attendance.dateAdded) BETWEEN '".$_GET['startDate']."' AND '".$_GET['endDate']."' ORDER BY attendance.dateAdded, attendance.classID");
...
?>
  ...
  <tr>
  <td>Instructor:</td>
  <td><?php echo $row_currentInstructor['firstName']; ?> <?php echo $row_currentInstructor['lastName']; ?></td>
    <td>&nbsp;</td>
  </tr>
