...
<h3 class="twd_centered"><?php echo $row_package['packageName']; ?>: $<?php echo $row_package['packageCost']; ?></h3>
<div style="text-align:center"><p><span style="color:#990000">Checkout with Paydunk and get <strong>$5 off all class packages</strong> (for a limited time)!</span><br />
...
mysql_select_db($database_wotg, $wotg);
$query_order = "INSERT INTO orders (amount, firstName, lastName, emailAddress, studioID, orderInfo, orderStatus, notes, paymentID, studentID, classesAdded) VALUES (".$orderAmount.", '".$row_student['firstName']."', '".$row_student['lastName']."','".$row_student['emailAddress']."',".$studioID.",'Pre Paid Package','pending','".$orderDescription."','".$payment->id."',".$studentID.",".$row_package['numberOfSessions'].")";
