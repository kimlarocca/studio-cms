...
<h1 class="twd_centered"><?php echo $row_currentUser['studioName']; ?> | Reports</h1>
...
<div class="twd_container">
  <div class="moduleContainer">
    ...
    <?php include("reports-members.php"); ?>
    <div class="module">
    <h2>More Reports</h2>
    <p><a class="button" style="margin-bottom:10px" href="orders.php">Order History</a></p>
    <p><a class="button" style="margin-bottom:10px" href="timesheets.php">Timesheets</a></p>
    <p><a class="button" style="margin-bottom:10px" href="reports-attendanceYearly.php">Yearly Attendance</a></p>
    <p><a class="button" style="margin-bottom:10px" href="reports-attendanceYearlyByClass.php">Yearly Attendance by Class</a></p>
    <p><a class="button" style="margin-bottom:10px" href="reports-attendanceByTime.php">Most Popular Time Slots</a></p>
    </div>
  </div>
</div>
