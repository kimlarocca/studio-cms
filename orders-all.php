...
mysql_select_db($database_wotg, $wotg);
$query_orders = "SELECT * FROM orders WHERE studioID = ".$row_currentUser['studioID']." ORDER BY orderID DESC";
...
<div class="twd_container">
  <table border="0" align="center" cellpadding="3" cellspacing="0">
    <tr>
      ...
      <td><strong> membership starts</strong></td>
...
echo date("m/d/Y", strtotime($row_orders['dateAdded'])); ?></td>
          <td><?php echo $row_orders['orderStatus']; ?></td>
          <td>$<?php echo $row_orders['amount']; ?></td>
          <td><?php echo $row_orders['paymentType']; ?></td>
          <td><?php echo $row_orders['membershipStartDate']; ?></td>
