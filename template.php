...
<div class="twd_container">
  <div class="twd_centered"> <a class="button" style="margin:0 10px 20px 0" href="attendance-sheet.php">Today's Attendance Sheet</a> </div>
  <div class="twd_row">
    ...
    <div class="twd_column twd_two twd_margin20">
      <h2 class="subheader">Client Waivers</h2>
