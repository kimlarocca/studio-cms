...
?>
  ...
  <h3 class="twd_centered twd_margin20">single session: <?php echo money_format('%.2n', $row_classes['classFee']); ?></h3>
<div style="text-align:center"><p><span style="color:#990000">Checkout with Paydunk and get an additional <strong>$5 off all single sessions</strong> (for a limited time)!</span><br />
