...
$query_attendance = "SELECT attendance.dateAdded AS attendanceDate,attendance.attendanceID, attendance.classID,attendance.studentID,attendance.paymentType,attendance.attendanceType, students.studentID, students.firstName,students.lastName,students.emailAddress,students.waiver,classes.classID,classes.name,instructors.instructorID,instructors.firstName AS iFirstName,instructors.lastName AS iLastName FROM attendance,students,classes,instructors WHERE students.studentID = ".$_GET['studentID']." AND attendance.studioID = ".$row_currentUser['studioID']." AND attendance.studentID = students.studentID AND attendance.classID = classes.classID AND attendance.instructorID=instructors.instructorID ORDER BY ".$sortBy;
}
...
<input class="twd_centered" type="submit" value="search" />
  ...
  <table border="0" align="center" cellpadding="3" cellspacing="0">
    <tr>
      <th><strong><a href="?<?php echo $_SERVER['QUERY_STRING'] ?>&sortBy=lastName">student</a></strong></th>
      <th><strong><a href="?<?php echo $_SERVER['QUERY_STRING'] ?>&sortBy=name">class</a></strong></th>
      <th><strong><a href="?<?php echo $_SERVER['QUERY_STRING'] ?>&sortBy=iFirstName">instructor</a></strong></th>
      <th><a href="?<?php echo $_SERVER['QUERY_STRING'] ?>&sortBy=attendanceDate"><strong>date added</strong></a></th>
      <th><strong>attendance type</strong></th>
      <th><strong>payment type</strong></th>
      <th>&nbsp;</th>
    </tr>
    <?php do { 
	$newDate = date("m/d/Y", strtotime($row_attendance['attendanceDate']));
	?>
      <tr>
