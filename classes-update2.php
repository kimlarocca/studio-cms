    ...
    <table align="center">
      ...
      <tr valign="baseline">
        ...
        <td><select name="startTime">
          <option value="5:00" <?php if (!(strcmp("5:00:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>5:00 AM</option>
          <option value="5:15" <?php if (!(strcmp("5:15:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>5:15 AM</option>
          <option value="5:30" <?php if (!(strcmp("5:30:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>5:30 AM</option>
<option value="5:45" <?php if (!(strcmp("5:45:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>5:45 AM</option>
          <option value="6:00" <?php if (!(strcmp("6:00:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>6:00 AM</option>
          <option value="6:15" <?php if (!(strcmp("6:15:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>6:15 AM</option>
          <option value="6:30" <?php if (!(strcmp("6:30:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>6:30 AM</option>
          <option value="6:45" <?php if (!(strcmp("6:45:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>6:45 AM</option>
          <option value="7:00" <?php if (!(strcmp("7:00:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>7:00 AM</option>
          <option value="7:15" <?php if (!(strcmp("7:15:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>7:15 AM</option>
          <option value="7:30" <?php if (!(strcmp("7:30:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>7:30 AM</option>
          <option value="7:45" <?php if (!(strcmp("7:45:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>7:45 AM</option>
          <option value="8:00" <?php if (!(strcmp("8:00:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>8:00 AM</option>
          <option value="8:15" <?php if (!(strcmp("8:15:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>8:15 AM</option>
          <option value="8:30" <?php if (!(strcmp("8:30:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>8:30 AM</option>
          <option value="8:45" <?php if (!(strcmp("8:45:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>8:45 AM</option>
          <option value="9:00" <?php if (!(strcmp("9:00:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>9:00 AM</option>
          <option value="9:15" <?php if (!(strcmp("9:15:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>9:15 AM</option>
          <option value="9:30" <?php if (!(strcmp("9:30:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>9:30 AM</option>
          <option value="9:45" <?php if (!(strcmp("9:45:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>9:45 AM</option>
...
<option value="20:30" <?php if (!(strcmp("20:30:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>8:30 PM</option>
          ...
          <option value="23:45" <?php if (!(strcmp("23:45:00", $row_classes['startTime']))) {echo "selected=\"selected\"";} ?>>11:45 PM</option></select></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Ends:</td>
        <td><select name="endTime">
          <option value="5:00" <?php if (!(strcmp("5:00:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>5:00 AM</option>
          <option value="5:15" <?php if (!(strcmp("5:15:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>5:15 AM</option>
          <option value="5:30" <?php if (!(strcmp("5:30:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>5:30 AM</option>
          <option value="5:45" <?php if (!(strcmp("5:45:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>5:45 AM</option>
          <option value="6:00" <?php if (!(strcmp("6:00:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>6:00 AM</option>
          <option value="6:15" <?php if (!(strcmp("6:15:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>6:15 AM</option>
          <option value="6:30" <?php if (!(strcmp("6:30:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>6:30 AM</option>
          <option value="6:45" <?php if (!(strcmp("6:45:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>6:45 AM</option>
          <option value="7:00" <?php if (!(strcmp("7:00:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>7:00 AM</option>
          <option value="7:15" <?php if (!(strcmp("7:15:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>7:15 AM</option>
          <option value="7:30" <?php if (!(strcmp("7:30:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>7:30 AM</option>
          <option value="7:45" <?php if (!(strcmp("7:45:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>7:45 AM</option>
          <option value="8:00" <?php if (!(strcmp("8:00:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>8:00 AM</option>
          <option value="8:15" <?php if (!(strcmp("8:15:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>8:15 AM</option>
          <option value="8:30" <?php if (!(strcmp("8:30:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>8:30 AM</option>
          <option value="8:45" <?php if (!(strcmp("8:45:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>8:45 AM</option>
          <option value="9:00" <?php if (!(strcmp("9:00:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>9:00 AM</option>
          <option value="9:15" <?php if (!(strcmp("9:15:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>9:15 AM</option>
          <option value="9:30" <?php if (!(strcmp("9:30:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>9:30 AM</option>
          <option value="9:45" <?php if (!(strcmp("9:45:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>9:45 AM</option>
        ...
        <option value="23:45" <?php if (!(strcmp("23:45:00", $row_classes['endTime']))) {echo "selected=\"selected\"";} ?>>11:45 PM</option></select></td>
      </tr>
      <tr valign="baseline">
