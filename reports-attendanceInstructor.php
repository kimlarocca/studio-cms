...
mysql_select_db($database_wotg, $wotg);
$query_classes = "SELECT classID, name, classDay, startTime, studioID FROM classes WHERE instructorID = ".$row_currentUser['instructorID']." AND classActive = 1 AND studioID = '".$studioID."' ORDER BY name ASC";
...
<title><?php echo $row_currentUser['studioName']; ?>| Attendance Report</title>
<script src="Chart.min.js"></script>
</head>
<body>
<?php include("header.php"); ?>
<h1 class="twd_centered"><?php echo $row_currentUser['studioName']; ?> | Class Popularity</h1>
...
?>
  <h2 class="twd_centered">Generate Class Popularity Reports</h2>
...
var dataAttendance = {
    ...
    datasets: [
        ...
        {//blue
            label: "<?php echo date('m/Y', strtotime($date1b))?>, <?php echo date('m/Y', strtotime($date2b))?>, <?php echo date('m/Y', strtotime($date3b))?>, <?php echo date('m/Y', strtotime($date4b))?>, <?php echo date('m/Y', strtotime($date5b))?>, <?php echo date('m/Y', strtotime($date6b))?>, <?php echo date('m/Y', strtotime($date7b))?>, <?php echo date('m/Y', strtotime($date8b))?>, <?php echo date('m/Y', strtotime($date9b))?>, <?php echo date('m/Y', strtotime($date11b))?>, <?php echo date('m/Y', strtotime($date12b))?>",
