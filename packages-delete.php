...
<div class="twd_container">
  <div class="twd_row">
    <div class="twd_column twd_two twd_margin20">
      <h2 class="twd_centered">Delete This Package?</h2>
      <p class="twd_centered twd_margin20"><strong><?php echo $row_package['packageName']; ?></strong></p>
      <div class="twd_centered"><a href="packages-delete2.php?packageID=<?php echo $row_package['packageID']; ?>" class="button">delete package</a></div>
    </div>
  </div>
</div>
