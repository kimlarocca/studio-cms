...
mysql_select_db($database_wotg, $wotg);
$query_wotg = "SELECT * FROM studios WHERE studioID = 1";
...
<div class="twd_container">
  <h2 class="twd_centered">Sample Waiver</h2>
  <div class="twd_centered twd_margin20"><a class="button" href="waiver-copy.php">go back &amp; update your waiver</a></div>
