...
<div class="twd_container">
      ...
      <h3 class="twd_centered twd_margin30"><?php echo $row_classes['name']; ?> on <?php echo $today ?></h3>
  <div class="twd_row">
...
?>
    ...
    <div class="twd_column twd_two twd_breakOnTablet">
      <h2 style="padding-bottom:0">Current Members <a href="javascript:void();" onclick="window.open('members-add.php','Add Member','height=500,width=300');return false;"><img src="images/addPerson.png" width="20" height="20" alt="add a new student" /></a></h2>
      <?php 
