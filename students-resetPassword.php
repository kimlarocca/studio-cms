...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateGoTo = "students-resetPassword.php?action=saved";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="twd_container">
  <h2 class="twd_centered">Reset Student Password</h2>
  <div class="twd_centered twd_margin20"><a class="button" href="students-update.php?studentID=<?php echo $row_students['studentID']; ?>"><img src="images/view.png" width="20" height="20" /> View Student Info</a></div>
  <?php
//check if changes were saved
if ($_GET['action'] == 'saved') print '<p class="twd_centered twd_margin20" style="color:red">Your changes have been saved!</p>'; 
?>
  <p class="twd_centered twd_margin20">Use the form below to reset this student's password.</p>
  <form class="twd_margin20" action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onsubmit="MM_validateForm('firstName','','R','lastName','','R','emailAddress','','NisEmail');return document.MM_returnValue">
    <table border="0" cellpadding="6" cellspacing="0" align="center">
      <tr valign="baseline">
        ...
        <td><input name="password" type="text" id="password" size="32" /></td>
      </tr>
      <tr valign="baseline">
