...
<div class="twd_container">
  <p class="twd_centered twd_margin20">Thank you! Your account has been verified.</p>
  <div class="twd_centered"> <a class="button" style="margin:0 10px 20px 0" href="admin.php">Return To The Dashboard</a> </div>
</div>
