...
mysql_select_db($database_wotg, $wotg);
$query_timesheet = sprintf("SELECT * FROM timeSheets WHERE sheetID = %s", GetSQLValueString($colname_timesheet, "int"));
...
<h2 class="twd_centered">Delete This Timesheet Entry?</h2>
  <div class="twd_centered">
    <table border="0" cellpadding="3" cellspacing="0" class="twd_margin20" align="center">
...
<a class="button" style="margin:0 10px 20px 0" href="timesheets-delete2.php?sheetID=<?php echo $row_timesheet['sheetID']; ?>">Delete This Entry</a> </div>
</div>
