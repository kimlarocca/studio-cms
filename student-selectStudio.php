...
$updaterecord = "UPDATE students SET studioID=".$studioID." WHERE studentID = ".$studentID;
...
$totalRows_student = "-1";
if (isset($_SESSION['MM_Username'])) {
  $totalRows_student = $_SESSION['MM_Username'];
}

mysql_select_db($database_wotg, $wotg);
$query_studios = "SELECT studioID, studioName FROM studios ORDER BY studioName ASC";
...
<div class="twd_container">
  <h2 class="twd_centered">Select Your Studio</h2>
  <p class="twd_centered twd_margin20">It looks like your account is not linked to a studio. Please click your studio's name on the list below to continue:</p>
  <table border="0" align="center" cellpadding="3" cellspacing="0">
    <?php do { ?>
      <tr>
        <td><a href="?studentID=<? echo $row_student['studentID']; ?>&studioID=<?php echo $row_studios['studioID']; ?>"><?php echo $row_studios['studioName']; ?></a></td>
      </tr>
