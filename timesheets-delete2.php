...
if ((isset($_GET['sheetID'])) && ($_GET['sheetID'] != "")) {
  $deleteSQL = sprintf("DELETE FROM timeSheets WHERE sheetID=%s",
                       GetSQLValueString($_GET['sheetID'], "int"));

  mysql_select_db($database_wotg, $wotg);
  $Result1 = mysql_query($deleteSQL, $wotg) or die(mysql_error());

  $deleteGoTo = "timesheets.php?action=deleted";
