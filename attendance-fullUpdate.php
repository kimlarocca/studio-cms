...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE attendance SET classID=%s, instructorID=%s, attendanceType=%s, addedBy=%s, paymentType=%s, checkedIn=%s WHERE attendanceID=%s",
...
mysql_select_db($database_wotg, $wotg);
$query_attendance = sprintf("SELECT * FROM attendance,students WHERE attendance.studentID=students.studentID AND attendance.attendanceID = %s", GetSQLValueString($colname_attendance, "int"));
...
?>
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    <table align="center">
      ...
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Date Added:</td>
        <td><?php echo $row_attendance['dateAdded']; ?></td>
      </tr>
      <tr valign="baseline">
