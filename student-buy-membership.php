...
<h1 class="studentH1 twd_centered"><?php echo $row_student['studioName']; ?> | Buy A Membership</h1>
<?php 
...
<div class="twd_container">
  ...
  <h3 class="twd_centered twd_margin20">Unlimited Monthly Membership: $<?php echo (int)$row_student['membershipFee']; ?></h3>
  <?php
$startDate = $_GET['startDate'];
$endDate = strtotime ( '+1 month' , strtotime ( $startDate ) ) ;
$endDate = date ( 'Y-m-d' , $endDate );
echo '<p class="twd_centered twd_margin20">Start Date: '.date("m/d/y", strtotime($startDate)).'<br></p>';
echo '<p class="twd_centered twd_margin20">End Date: '.date("m/d/y", strtotime($endDate)).'</p>';
?>
<!--
<div style="text-align:center"><p><span style="color:#990000">Checkout with Paydunk and get an additional <strong>$5 off all memberships</strong> (for a limited time)!</span><br />
...
//get order info
$orderDescription = 'Membership for $'.$row_student['membershipFee'];
$orderAmount = (int)$row_student['membershipFee'];
...
$query_order = "INSERT INTO orders (amount, firstName, lastName, emailAddress, studioID, orderInfo, orderStatus, notes, paymentID, studentID, membershipStartDate) VALUES (".$orderAmount.", '".$firstName."', '".$lastName."','".$row_student['emailAddress']."',".$studioID.",'Membership','pending','".$orderDescription."','".$payment->id."','".$studentID."','".$startDate."')";
