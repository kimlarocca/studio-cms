...
<div class="twd_centered">
      ...
      <a class="button" style="margin:0 10px 20px 0" href="reports-attendanceInstructor.php">CLASS POPULARITY</a>
</div>
  <div class="twd_row">
    <div class="twd_column twd_two twd_margin20">
   
      <h2 class="subheader">Your Attendance Reports</h2>
      <p>Use the form below to generate your attendance reports:</p>
      <form method="get" action="instructor-attendance-report.php" name="form0" class="twd_margin20">
