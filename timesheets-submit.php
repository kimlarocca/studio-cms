...
//update record
$updaterecord = "UPDATE timeSheets SET entryStatus='submitted' WHERE entryStatus IS NULL AND instructorID = ".$row_currentUser['instructorID'];
mysql_select_db($database_wotg, $wotg);
