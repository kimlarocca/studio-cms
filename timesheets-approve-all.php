...
//update record
$updaterecord = "UPDATE timeSheets,instructors SET timeSheets.entryStatus='approved' WHERE instructors.instructorID=timeSheets.instructorID AND timeSheets.entryStatus='submitted' AND instructors.studioID = ".$studioID;
mysql_select_db($database_wotg, $wotg);
mysql_query($updaterecord, $wotg) or die(mysql_error());  

header("Location: timesheets-admin.php");
?>
