...
<div class="twd_container">
  ...
  <h3>Unlimited Membership: $<?php echo $row_student['membershipFee']; ?></h3>
<?php
$startDate = date("Y-m-d", strtotime("now"));
$endDate = strtotime ( '+1 month' , strtotime ( $startDate ) ) ;
$endDate = date ( 'Y-m-d' , $endDate );
echo '<p>Start Date: '.date("m/d/y", strtotime($startDate)).'</p>';
echo '<p>End Date: '.date("m/d/y", strtotime($endDate)).'</p>';
?>
<?php
...
$id = mysql_insert_id();
 echo '<a href='.$approvalUrl.'><img src="../images/paypal.png" width="142" height="27"></a>';
